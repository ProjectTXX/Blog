...
export default new Vuex.Store({
  ...
  actions: {
    fetchArticles({ commit }) {
      axios.get('http://6ab87a7c.r19.cpolar.top/api/v1/articles')
        .then(response => {
